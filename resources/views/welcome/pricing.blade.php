        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="relative z-10">
                ...
                <p class="mx-auto mt-4 max-w-2xl text-center text-lg leading-8 text-white/80">
                    Discover Eddy today with our <b class="text-white">5-day free trial</b> and choose a plan that fits your needs. Support open-source development while enjoying hassle-free server management and deployment. Join Eddy and Splade's community today!
                </p>
            ...
            <div class="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:max-w-none lg:grid-cols-3">
                <div class="hidden lg:absolute lg:inset-x-px lg:bottom-0 lg:top-4 lg:block lg:rounded-2xl lg:bg-gray-800/80 lg:ring-1 lg:ring-white/10" aria-hidden="true"></div>
