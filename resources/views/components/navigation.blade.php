...
<x-splade-rehydrate on="refresh-navigation-menu, profile-information-updated">
    <nav class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-3 md:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <!-- Navigation Links -->
                    <div class="hidden space-x-4 md:space-x-5 lg:space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden sm:flex sm:items-center ml-4 md:ml-6">
