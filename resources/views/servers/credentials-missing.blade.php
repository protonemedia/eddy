...
<x-app-layout>
    <x-action-section>
        ...
        <x-slot:content>
            ...
            <div class="space-x-4">
                <x-splade-button type="link" modal href="{{ route('credentials.create', ['forServer' => true]) }}" class="inline-block mt-4">
                    {{ __('Create Credentials') }}
                </x-splade-button>

                <x-splade-button type="link" secondary keep-modal href="{{ route('servers.create', ['withoutCredentials' => true]) }}" class="inline-block mt-4">
